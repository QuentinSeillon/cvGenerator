...
function Cv() {
    ...
    return (
        <div className="container mt-4">
                ...
                {visibleCvs.map(cv => (
                    <div key={cv._id} className="col-4 mb-4">
                        <div className="card overflow-scroll" style={{ width: '300px', height: '400px', position: 'relative' }}>
                            <div className="position-absolute top-0 start-0 bg-danger text-white p-2" style={{ borderRadius: '0 5px 5px 0' }}>
                            ...
                            <div className="card-body d-flex flex-column justify-content-between align-items-center gap-1">
                                <h5 className="card-title">{cv.nom} {cv.prenom}</h5>
            ...
            <div className="modal fade show" id="viewRecommendationsModal" tabIndex="-1" style={{ display: selectedRecommendations.length > 0 ? 'block' : 'none' }}>
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            <button type="button" className="btn btn-secondary" onClick={() => setSelectedRecommendations([])}>Fermer</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="modal fade show" id="recommendationModal" tabIndex="-1" style={{ display: selectedCv ? 'block' : 'none' }}>
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-header">
                        ...
                        <div className="modal-footer">
                            <button type="button" className="btn btn-secondary" onClick={() => setSelectedCv(null)}>Annuler</button>
                            <button type="button" className="btn btn-primary" onClick={handleAddRecommendation}>Envoyer</button>
                        </div>
                    </div>
                </div>
            </div>
